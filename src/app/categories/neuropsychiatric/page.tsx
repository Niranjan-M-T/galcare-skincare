          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            ...
            <ScrollReveal>
              <div className="relative w-full aspect-[4/5] bg-gray-50 rounded-[2rem] overflow-hidden flex items-center justify-center p-12 group">
                ...
                <Image 
                  ...
                  alt="Neuropsychiatric Formulations" 
                  width={400} 
                  height={600} 
            ...
            <div className="flex flex-col justify-center pt-8 lg:pt-16">
              <ScrollReveal delay={100}>
                <span className="text-sm font-bold tracking-widest uppercase text-gray-400 mb-4 block">Central Nervous System</span>
                ...
                <p className="text-lg text-gray-600 mb-10 leading-relaxed font-medium">
                  Empowering minds with comprehensive, clinically proven solutions. Galcare is committed to improving patient outcomes in mental health and neurology through specialized molecular support systems.
                </p>
                ...
                <div className="flex flex-col">
                  <Accordion 
                    title="Focus Areas" 
                    content="Our specialized neuropsychiatric division offers a range of high-quality formulations including anti-depressants, anti-anxiety, anti-psychotics, and mood stabilizers." 
                    isOpen={openAccordion === 0} 
                    onClick={() => setOpenAccordion(openAccordion === 0 ? null : 0)} 
                  />
                  <Accordion 
                    title="Manufacturing Capacity" 
                    content="Operating state-of-the-art facilities capable of large-scale production of solid oral doses (tablets/capsules) under strict GMP guidelines to ensure consistent dosage delivery." 
                    isOpen={openAccordion === 1} 
                    onClick={() => setOpenAccordion(openAccordion === 1 ? null : 1)} 
                  />
                  <Accordion 
                    title="Bioequivalence" 
                    content="Every batch undergoes rigorous dissolution and bioavailability testing to ensure it matches innovator drug performance and safety profiles." 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={200} className="h-full">
              <div className="w-full h-full min-h-[300px] rounded-[2rem] border border-gray-200 p-10 flex flex-col justify-center hover:border-blue-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300 bg-white">
                ...
                <p className="text-gray-500 font-medium text-sm leading-relaxed">
                  Advanced granulation and coating techniques ensure precise active ingredient delivery, critical for neurological and psychiatric treatments.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300} className="h-full">
              <div className="w-full h-full min-h-[300px] rounded-[2rem] border border-gray-200 p-10 flex flex-col justify-center hover:border-blue-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300 bg-white">
                ...
                <p className="text-gray-500 font-medium text-sm leading-relaxed">
                  Specialized modified-release formulations designed to maintain steady plasma concentrations and improve patient compliance.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <ScrollReveal delay={100}>
              <div className="bg-white rounded-[2rem] border border-gray-200 p-8 flex flex-col sm:flex-row gap-8 items-center group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="relative w-full sm:w-1/2 aspect-square rounded-[1.5rem] overflow-hidden shrink-0 shadow-inner bg-purple-50/50">
                  <Image src="/images/product-2.png" alt="Anti-Depressants" fill sizes="(max-width: 768px) 100vw, 25vw" className="object-contain p-4 group-hover:scale-105 transition-transform duration-700 ease-[var(--ease-spring)] mix-blend-multiply" />
                </div>
                <div className="w-full sm:w-1/2">
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Anti-Depressants & Anti-Anxiety</h3>
                  <p className="text-sm text-gray-500 leading-relaxed font-medium">
                    State-of-the-art SSRI, SNRI, and anxiolytic formulations designed to support serotonin and neurotransmitter balance effectively.
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <div className="bg-white rounded-[2rem] border border-gray-200 p-8 flex flex-col sm:flex-row gap-8 items-center group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="relative w-full sm:w-1/2 aspect-square rounded-[1.5rem] overflow-hidden shrink-0 shadow-inner bg-indigo-50/50">
                  <Image src="/images/product-2.png" alt="Mood Stabilizers" fill sizes="(max-width: 768px) 100vw, 25vw" className="object-contain p-4 group-hover:scale-105 transition-transform duration-700 ease-[var(--ease-spring)] mix-blend-multiply" />
                </div>
                <div className="w-full sm:w-1/2">
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Mood Stabilizers & Anti-Epileptics</h3>
                  <p className="text-sm text-gray-500 leading-relaxed font-medium">
                    Critical neuro-modulating compounds formulated for precise, steady-state absorption to prevent symptom relapse and manage chronic conditions.
                  </p>
                </div>
              </div>
            </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal delay={100} className="w-full">
              <StepAccordion 
                ...
                content="Rigorous vetting of Active Pharmaceutical Ingredients to ensure purity profiles match stringent central nervous system delivery requirements."
                isOpen={openStep === 1}
              ...
              <StepAccordion 
                ...
                content="High-shear granulation and fluid bed processing to ensure uniform distribution of highly potent active ingredients."
                isOpen={openStep === 2}
                onClick={() => setOpenStep(openStep === 2 ? null : 2)}
              />
              <StepAccordion 
                num={3} 
                title="Compression & Coating" 
                content="Precision compression followed by specialized film or enteric coating to protect the active ingredient and control release timing in the body."
                isOpen={openStep === 3}
                onClick={() => setOpenStep(openStep === 3 ? null : 3)}
              />
              <StepAccordion 
                num={4} 
                title="Bio-Equivalence Testing" 
                content="In-vitro dissolution profiling and chemical assays to guarantee each tablet performs exactly identically to therapeutic standards."
                isOpen={openStep === 4}
              ...
              <StepAccordion 
                ...
                content="Moisture and light-resistant Alu-Alu or PVDC blister packing to ensure shelf-life stability of sensitive neurological compounds."
                isOpen={openStep === 5}
